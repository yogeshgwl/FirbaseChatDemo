...
import com.aucto.model.Syncable;

import java.util.List;

/***
 * SyncDao interface used by SyncManager. A SyncDao implementation should be created for
 ...
 */
public interface SyncDao<T extends Syncable> {
	/***
